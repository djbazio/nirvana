...
Route::group(['prefix'=>'admin', 'middleware' => ['auth', 'revalidate'] ], function(){
	...
	Route::get('print-barcode-by-purchase', 'ProductController@printBarcodeByPurchase')->name('product.print_barcode_by_purchase');
	...
	Route::get('upload-bulk-product', ['uses' => 'ProductController@uploadBulkProduct'])->name('product.upload');
	Route::post('upload-bulk-product', ['uses' => 'ProductController@postBulkProduct'])->name('post.product.upload');


	//Excel Download
	Route::get('download/excel', ['uses' => 'ProductController@getExcelDownload'])->name('product.export.excel');
